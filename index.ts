...
export const getLeetUserProfile = async function (req: { params: { user: any } }, res: { send: (arg0: UserResponse) => void }) {
...
export const getLeetQuestions = async function (_req: any, res: { send: (arg0: QuestionsResponse) => void }) {
